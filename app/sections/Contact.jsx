...
const Contact = () => {
  return (
    <div id="contact">
      ...
      <div className="bg-white flex flex-wrap justify-center items-center rounded-xl m-10 md:mt-6 mt-4 max-lg:p-4 lg:w-fit lg:mx-auto lg:px-10 lg:gap-20 md:gap-10 shadow-xl">
        ...
        <div className="lg:w-[300px] md:w-[200px] mb-2">
          ...
          <p className="font-medium lg:text-base md:text-sm text-xs text-gray-600 lg:mt-4 lg:mb-6 my-4">
            We are available on WhatsApp or just call us at +91-9007841377.
          </p>
